...
/***********************************BACK_END*******************************************/
		...
		JTable tableupdategroup;
		JScrollPane scrollpaneupdategroup;
		...
		public void definitioncomp() {
		    ...
		    String[] columnupdategroup = {"Contact Name", "City", "Add to group"};
		    Object[][] dataupdategroup = {
		      {"", "", true },
		      {"", "", true },
		      {"", "", true },
		      {"", "", true }
		    };
		    DefaultTableModel model = new DefaultTableModel(dataupdategroup, columnupdategroup);
		    tableupdategroup = new JTable(model){
		    	...
		    	scrollpaneupdategroup = new JScrollPane(tableupdategroup);
		...
		public void rigthpaneldetails() {
			...
			scrollpaneupdategroup.setBounds(0,75,300,150);
			...
			rigthpaneldetails.add(scrollpaneupdategroup);		
		}
