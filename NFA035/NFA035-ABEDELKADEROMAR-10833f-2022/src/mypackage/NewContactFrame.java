...
/*****************************FRONT_END***********************************************/
		...
		NewContactFrame()
		{
			...
			//Button Handler for saving the new contact
	        saveButt.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					if(firstnameTf.getText().isEmpty() || lastnameTf.getText().isEmpty() || cityTf.getText().isEmpty() || adressTf.getText().isEmpty())
					{
			            JOptionPane.showMessageDialog(frame,"Un Contact doit avoir un first name, last name,un city, un adress"); 
		            }else{
                                            String firstName = firstnameTf.getText();
                                            String lastName = lastnameTf.getText();
                                            String city = cityTf.getText();
                                            String adress = adressTf.getText();
                                            //JTable tablecontact = tablecontact.getDataVector(); 
	      ...
	      //Button Handler for cancel button and return the main contact frame
...
/***********************************BACK_END*******************************************/
		...
		JTable tablenewcontact;
		JScrollPane scrollpanenewcontact;
		...
		public void definitioncomp() {
			...
			String columnnewcontact[]={"Region Code","Phone Number"};
		    String datanewcontact[][]={ {"",""}};
			try{
				tablenewcontact = new JTable(datanewcontact,columnnewcontact);
			}catch(Exception e) {
				
			}	
			scrollpanenewcontact = new JScrollPane(tablenewcontact);
		}
		...
		public void rigthpaneldetails() {
			...
			scrollpanenewcontact.setBounds(0,150,300,150);
			...
			rigthpaneldetails.add(scrollpanenewcontact);
